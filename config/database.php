...
if (is_string($sqliteDatabase) && $sqliteDatabase !== '' && $sqliteDatabase !== ':memory:') {
    $sqliteDatabasePath = str_starts_with($sqliteDatabase, DIRECTORY_SEPARATOR)
        ? $sqliteDatabase
        : base_path($sqliteDatabase);

    $sqliteDirectory = dirname($sqliteDatabasePath);
